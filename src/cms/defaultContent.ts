...
const theOnePackageItems: CmsBlockItem[] = [
  {
    ...
    packageMetrics: [
      { value: '45', label: 'content units/tháng' },
      { value: '15+', label: 'video ngắn/tháng' },
      { value: '10', label: 'landing pages tối đa' },
    ],
    features: [
      { label: 'CAPACITY', text: '45 content units/month, tối thiểu 15 reels/short-form videos.', availability: 'included', module: 'output', statusLabel: '45/tháng' },
      { label: 'CONTENT ENGINE', text: 'Content strategy, content calendar, production, posting and optimization.', availability: 'included', module: 'content' },
      { label: 'WEBSITE SYSTEM', text: 'Basic booking website, tối đa 10 landing pages.', availability: 'included', module: 'web', statusLabel: 'Tối đa 10' },
      { label: 'PERFORMANCE MEDIA', text: 'Performance marketing theo % trên ad spend thực tế.', availability: 'included', module: 'growth' },
      { label: 'E-COMMERCE OPS', text: 'E-commerce management (Shopee, TikTok Shop, Lazada...)', availability: 'excluded', module: 'web' },
      { label: 'WEBSITE SYSTEM', text: 'Unlimited landing pages', availability: 'excluded', module: 'web' },
    ],
    comparisonRows: [
      { label: 'Content units', value: '45/tháng', availability: 'included', module: 'output' },
      { label: 'Video ngắn', value: 'Tối thiểu 15/tháng', availability: 'included', module: 'output' },
      { label: 'Content engine', value: 'Bao gồm', availability: 'included', module: 'content' },
      { label: 'Booking/sales website', value: 'Cơ bản', availability: 'included', module: 'web' },
      { label: 'Landing pages', value: 'Tối đa 10', availability: 'included', module: 'web' },
      { label: 'E-commerce ops', value: 'Không bao gồm', availability: 'excluded', module: 'web' },
      { label: 'Performance media', value: 'Theo % ad spend thực tế', availability: 'included', module: 'growth' },
      { label: 'Event execution', value: 'Không bao gồm', availability: 'excluded', module: 'growth' },
    ],
    priceLabel: 'From',
    ...
    locales: {
      en: {
        ...
        packageMetrics: [
          { value: '45', label: 'content units/month' },
          { value: '15+', label: 'short videos/month' },
          { value: '10', label: 'landing pages max' },
        ],
        features: [
          { label: 'CAPACITY', text: '45 content units/month, minimum 15 reels/short-form videos.', availability: 'included', module: 'output', statusLabel: '45/month' },
          { label: 'CONTENT ENGINE', text: 'Content strategy, content calendar, production, posting and optimization.', availability: 'included', module: 'content' },
          { label: 'WEBSITE SYSTEM', text: 'Basic booking website, up to 10 landing pages.', availability: 'included', module: 'web', statusLabel: 'Up to 10' },
          { label: 'PERFORMANCE MEDIA', text: 'Performance marketing based on actual ad spend.', availability: 'included', module: 'growth' },
          { label: 'E-COMMERCE OPS', text: 'E-commerce management (Shopee, TikTok Shop, Lazada...)', availability: 'excluded', module: 'web' },
          { label: 'WEBSITE SYSTEM', text: 'Unlimited landing pages', availability: 'excluded', module: 'web' },
        ],
        comparisonRows: [
          { label: 'Content units', value: '45/month', availability: 'included', module: 'output' },
          { label: 'Short videos', value: 'Minimum 15/month', availability: 'included', module: 'output' },
          { label: 'Content engine', value: 'Included', availability: 'included', module: 'content' },
          { label: 'Booking/sales website', value: 'Basic', availability: 'included', module: 'web' },
          { label: 'Landing pages', value: 'Up to 10', availability: 'included', module: 'web' },
          { label: 'E-commerce ops', value: 'No access', availability: 'excluded', module: 'web' },
          { label: 'Performance media', value: 'Based on actual ad spend', availability: 'included', module: 'growth' },
  ...
  },
  {
    ...
    packageMetrics: [
      { value: '60', label: 'content units/tháng' },
      { value: '20+', label: 'video ngắn/tháng' },
      { value: '∞', label: 'landing pages' },
    ],
    features: [
      { label: 'CAPACITY', text: '60 content units/month, tối thiểu 20 reels/short-form videos.', availability: 'included', module: 'output', statusLabel: '60/tháng' },
      { label: 'CONTENT ENGINE', text: 'Content strategy, content calendar, production, posting and optimization.', availability: 'included', module: 'content' },
      { label: 'ECOMMERCE OPS', text: 'E-commerce management (Shopee, TikTok Shop, Lazada...)', availability: 'included', module: 'web', statusLabel: 'Full access' },
      { label: 'WEBSITE SYSTEM', text: 'Booking/sales website, unlimited landing pages.', availability: 'included', module: 'web', statusLabel: 'Unlimited' },
      { label: 'PERFORMANCE MEDIA', text: 'Performance marketing theo % trên ad spend thực tế.', availability: 'included', module: 'growth' },
    ],
    comparisonRows: [
      { label: 'Content units', value: '60/tháng', availability: 'included', module: 'output' },
      { label: 'Video ngắn', value: 'Tối thiểu 20/tháng', availability: 'included', module: 'output' },
      { label: 'Content engine', value: 'Bao gồm', availability: 'included', module: 'content' },
      { label: 'Booking/sales website', value: 'Bao gồm', availability: 'included', module: 'web' },
      { label: 'Landing pages', value: 'Không giới hạn', availability: 'included', module: 'web' },
      { label: 'E-commerce ops', value: 'Full access', availability: 'included', module: 'web' },
      { label: 'Performance media', value: 'Theo % ad spend thực tế', availability: 'included', module: 'growth' },
      { label: 'Event execution', value: 'Không bao gồm', availability: 'excluded', module: 'growth' },
    ],
    priceLabel: 'From',
    ...
    locales: {
      en: {
        ...
        features: [
          { label: 'CAPACITY', text: '60 content units/month, minimum 20 reels/short-form videos.', availability: 'included', module: 'output', statusLabel: '60/month' },
          { label: 'CONTENT ENGINE', text: 'Content strategy, content calendar, production, posting and optimization.', availability: 'included', module: 'content' },
          { label: 'ECOMMERCE OPS', text: 'E-commerce management (Shopee, TikTok Shop, Lazada...)', availability: 'included', module: 'web', statusLabel: 'Full access' },
          { label: 'WEBSITE SYSTEM', text: 'Booking/sales website, unlimited landing pages.', availability: 'included', module: 'web', statusLabel: 'Unlimited' },
          { label: 'PERFORMANCE MEDIA', text: 'Performance marketing based on actual ad spend.', availability: 'included', module: 'growth' },
        ...
        comparisonRows: [
          { label: 'Content units', value: '60/month', availability: 'included', module: 'output' },
          { label: 'Short videos', value: 'Minimum 20/month', availability: 'included', module: 'output' },
          { label: 'Content engine', value: 'Included', availability: 'included', module: 'content' },
          { label: 'Booking/sales website', value: 'Included', availability: 'included', module: 'web' },
          { label: 'Landing pages', value: 'Unlimited', availability: 'included', module: 'web' },
          { label: 'E-commerce ops', value: 'Full access', availability: 'included', module: 'web' },
          { label: 'Performance media', value: 'Based on actual ad spend', availability: 'included', module: 'growth' },
          { label: 'Event execution', value: 'No access', availability: 'excluded', module: 'growth' },
        ],
  ...
  },
  {
    ...
    packageMetrics: [
      { value: 'System', label: 'đã bao gồm' },
      { value: 'On-site', label: 'event operations' },
      { value: 'Custom', label: 'campaign scope' },
    ],
    features: [
      { label: 'SYSTEM BASE', text: 'Everything included in The One System.', availability: 'included', module: 'content', statusLabel: 'System included' },
      { label: 'EVENT OPS', text: 'On-site event planning and execution.', availability: 'included', module: 'growth', statusLabel: 'On-site' },
      { label: 'CAMPAIGN GROWTH', text: 'Campaign strategy, creative direction, media planning.', availability: 'included', module: 'growth', statusLabel: 'Custom' },
    ],
    comparisonRows: [
      { label: 'Content units', value: 'Theo scope', availability: 'included', module: 'output' },
      { label: 'Video ngắn', value: 'Theo scope', availability: 'included', module: 'output' },
      { label: 'Content engine', value: 'Bao gồm System', availability: 'included', module: 'content' },
      { label: 'Booking/sales website', value: 'Bao gồm System', availability: 'included', module: 'web' },
      { label: 'Landing pages', value: 'Không giới hạn', availability: 'included', module: 'web' },
      { label: 'E-commerce ops', value: 'Full access', availability: 'included', module: 'web' },
      { label: 'Performance media', value: 'Bao gồm System', availability: 'included', module: 'growth' },
      { label: 'Event execution', value: 'On-site', availability: 'included', module: 'growth' },
    ],
    priceLabel: 'Custom',
    ...
    locales: {
      en: {
        ...
        comparisonRows: [
          { label: 'Content units', value: 'Custom scope', availability: 'included', module: 'output' },
          { label: 'Short videos', value: 'Custom scope', availability: 'included', module: 'output' },
          { label: 'Content engine', value: 'System included', availability: 'included', module: 'content' },
          { label: 'Booking/sales website', value: 'System included', availability: 'included', module: 'web' },
          { label: 'Landing pages', value: 'Unlimited', availability: 'included', module: 'web' },
          { label: 'E-commerce ops', value: 'Full access', availability: 'included', module: 'web' },
          { label: 'Performance media', value: 'System included', availability: 'included', module: 'growth' },
          { label: 'Event execution', value: 'On-site', availability: 'included', module: 'growth' },
        ],
        priceLabel: 'Custom',
        priceValue: 'Custom package',
...
export const defaultCmsPages: CmsPageContent[] = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        packageProcessSteps: [
          { title: 'Discovery & scoping', body: 'Chốt mục tiêu, phạm vi và gói phù hợp trước khi bắt đầu.' },
          { title: 'System setup', body: 'Thiết lập workflow, quyền truy cập và nhịp phối hợp.' },
          { title: 'Monthly operating loop', body: 'Vận hành, đo lường và tối ưu theo nhịp hàng tháng.' },
        ],
        packageRecommendationTitle: 'Chưa chắc gói nào phù hợp?',
        packageRecommendationBody: 'Chia sẻ mục tiêu và hiện trạng; The One sẽ đề xuất gói phù hợp với phạm vi thực tế.',
        packageRecommendationCta: 'Nhận đề xuất gói',
        ...
        locales: {
          en: {
            ...
            packageProcessSteps: [
              { title: 'Discovery & scoping', body: 'Align on goals, scope and the right package before work begins.' },
              { title: 'System setup', body: 'Set up workflows, access and the working cadence.' },
